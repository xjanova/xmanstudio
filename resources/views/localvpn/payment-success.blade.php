                ...
                @if(isset($licenses) && $licenses->count() > 0 && $licenses->first()->machine_id)
                    <div class="bg-cyan-900/30 border border-cyan-500/30 rounded-xl p-6 text-left mb-6">
                        ...
                        <ol class="space-y-2 text-sm text-gray-300 list-decimal list-inside">
                            ...
                            <li>เปิดแอพ LocalVPN — ระบบจะตรวจสอบ License ให้โดยอัตโนมัติ</li>
                ...
                @elseif(isset($licenses) && $licenses->count() > 0)
                    <div class="bg-cyan-900/30 border border-cyan-500/30 rounded-xl p-6 text-left mb-6">
                        ...
                        <ol class="space-y-2 text-sm text-gray-300 list-decimal list-inside">
                            ...
                            <li>เปิดแอพ LocalVPN แล้วกรอก License Key</li>
                ...
                @else
                    <div class="bg-cyan-900/30 border border-cyan-500/30 rounded-xl p-6 text-left mb-6">
                        ...
                        <ol class="space-y-2 text-sm text-gray-300 list-decimal list-inside">
                            ...
                            <li>เมื่อยืนยันการชำระเงินแล้ว License Key จะถูกส่งไปยังอีเมล <span class="text-cyan-400">{{ $order->customer_email }}</span></li>
                            <li>นำ License Key ไปกรอกในแอพ LocalVPN เพื่อเปิดใช้งาน</li>
                        </ol>
                    </div>
                @endif
