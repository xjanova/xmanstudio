            ...
            <div class="p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-gray-400">
                        แพ็กเกจ: <span class="font-semibold text-cyan-400">LocalVPN {{ $planInfo['name'] }}</span>
                    </p>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <ul class="mt-1 text-sm text-gray-300 list-disc list-inside space-y-1">
                                ...
                                <li>License Key จะส่งไปยังอีเมล: <span class="text-cyan-400">{{ $order->customer_email }}</span></li>
