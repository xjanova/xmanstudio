...
@section('title', 'วิธีติดตั้ง LocalVPN - คู่มือฉบับสมบูรณ์')
...
<div class="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-gray-900 text-white">
    ...
    <div class="max-w-5xl mx-auto px-4 pt-12 pb-8 text-center">
        ...
        <div class="w-16 h-16 mx-auto mb-5 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
            </svg>
        </div>
        <h1 class="text-3xl md:text-4xl font-bold mb-3">วิธีติดตั้ง LocalVPN</h1>
        <p class="text-teal-300 text-lg max-w-2xl mx-auto">คู่มือฉบับสมบูรณ์ — ติดตั้งและเริ่มใช้งานภายใน 5 นาที</p>
        <div class="flex items-center justify-center gap-4 mt-6 text-sm text-teal-400">
    ...
    <div class="max-w-5xl mx-auto px-4 pb-16">
        ...
        <div class="mb-16" id="step-1">
            <div class="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div class="flex-shrink-0">
                    ...
                    @else
                        <div class="phone-frame">
                            <div class="phone-screen bg-gradient-to-b from-gray-900 to-gray-900 flex flex-col items-center justify-center p-6 text-center">
                                <div class="w-12 h-12 bg-emerald-500/30 rounded-xl flex items-center justify-center mb-4">
                                    <svg class="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9"/></svg>
                                </div>
                                <p class="text-white text-sm font-medium mb-1">xman4289.com</p>
                                <p class="text-teal-300 text-xs mb-4">/localvpn/download</p>
                                <div class="w-full bg-emerald-600 rounded-lg py-2.5 px-4 text-white text-sm font-medium flex items-center justify-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                                    ดาวน์โหลด APK
                                </div>
                                <div class="mt-3 text-teal-400 text-xs">v1.2.27 • 161 MB</div>
                            </div>
                        </div>
                    @endif
                </div>
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-emerald-500/30">1</span>
                        <h2 class="text-2xl font-bold">ดาวน์โหลด APK</h2>
                    </div>
                    <div class="space-y-3 text-teal-200">
                        <p>เปิดเบราว์เซอร์บนมือถือ Android แล้วไปที่:</p>
                        <div class="bg-white/10 border border-white/20 rounded-xl px-4 py-3 font-mono text-emerald-300 text-sm flex items-center justify-between">
                            <span>xman4289.com/localvpn/download</span>
                            <button onclick="navigator.clipboard.writeText('https://xman4289.com/localvpn/download')" class="text-xs bg-emerald-500/30 hover:bg-emerald-500/50 px-2 py-1 rounded transition">คัดลอก</button>
                        </div>
                        <p>กดปุ่ม <strong class="text-emerald-400">"ดาวน์โหลด APK"</strong> รอไฟล์ดาวน์โหลดเสร็จ (ขนาดประมาณ 160 MB)</p>
        ...
        <div class="mb-16" id="step-2">
            <div class="flex flex-col lg:flex-row-reverse items-center gap-8">
                        ...
                        <div class="phone-frame">
                            <div class="phone-screen bg-gray-100 flex flex-col p-4">
                                ...
                                <div class="bg-white rounded-xl p-3 shadow-sm flex items-center justify-between">
                                    ...
                                    <div class="w-10 h-6 bg-emerald-500 rounded-full flex items-center justify-end px-0.5">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-emerald-500/30">2</span>
                    ...
                    <div class="space-y-3 text-teal-200">
                        ...
                        <ol class="space-y-2 text-sm">
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">a</span>
                                <span>เมื่อดาวน์โหลดเสร็จ กดเปิดไฟล์ <code class="bg-white/10 px-1.5 py-0.5 rounded text-emerald-300">LocalVPN-v1.2.27.apk</code></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">b</span>
                                <span>ระบบจะแสดงข้อความ <strong class="text-white">"ไม่อนุญาตให้ติดตั้งจากแหล่งนี้"</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">c</span>
                                <span>กด <strong class="text-emerald-400">"ตั้งค่า"</strong> → เปิดสวิตช์ <strong class="text-emerald-400">"อนุญาตจากแหล่งนี้"</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">d</span>
        ...
        <div class="mb-16" id="step-3">
            <div class="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    @else
                        <div class="phone-frame">
                            <div class="phone-screen bg-gray-100 flex flex-col items-center justify-center p-6">
                                <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                                    <span class="text-white text-2xl font-bold">T</span>
                                </div>
                                <p class="text-gray-900 text-sm font-semibold mb-1">ต้องการติดตั้งแอปนี้?</p>
                                <p class="text-gray-500 text-xs mb-1">LocalVPN</p>
                                <p class="text-gray-400 text-xs mb-4">161 MB</p>
                                <div class="w-full space-y-2">
                                    <div class="w-full bg-emerald-600 rounded-lg py-2 text-white text-sm font-medium text-center">ติดตั้ง</div>
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-emerald-500/30">3</span>
                    ...
                    <div class="space-y-3 text-teal-200">
                        ...
                        <ul class="space-y-2 text-sm">
                            <li class="flex items-start gap-2">
                                ...
                                <span>กดปุ่ม <strong class="text-emerald-400">"ติดตั้ง"</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-5 h-5 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        ...
                        <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-4 py-3 text-emerald-200 text-sm flex gap-2">
                            ...
                            <span>LocalVPN ผ่านการ sign ด้วย keystore อย่างเป็นทางการ — ปลอดภัย 100%</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-16" id="step-4">
            <div class="flex flex-col lg:flex-row-reverse items-center gap-8">
                            ...
                            <div class="phone-screen bg-gray-100 flex flex-col p-4">
                                ...
                                <div class="bg-white rounded-xl p-3 mb-2 shadow-sm">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-gray-900 text-sm font-medium">LocalVPN Service</p>
                                ...
                                <div class="mt-2 bg-white rounded-xl p-3 shadow-sm border-2 border-emerald-500">
                                    <p class="text-gray-900 text-sm font-medium mb-1">⚠️ เปิดใช้ LocalVPN Service?</p>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <div class="flex-1 bg-emerald-600 rounded-lg py-1.5 text-white text-xs text-center font-medium">อนุญาต</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-emerald-500/30">4</span>
                        <h2 class="text-2xl font-bold">เปิด Accessibility Service</h2>
                    </div>
                    <div class="space-y-3 text-teal-200">
                        <p>LocalVPN ต้องใช้ <strong class="text-white">Accessibility Service</strong> เพื่อพิมพ์ข้อความอัตโนมัติ:</p>
                        <ol class="space-y-2 text-sm">
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">a</span>
                                <span>เปิดแอพ LocalVPN → จะแสดงหน้าแนะนำให้เปิดสิทธิ์</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">b</span>
                                <span>กด <strong class="text-emerald-400">"ไปเปิดสิทธิ์"</strong> → ระบบจะพาไปหน้าตั้งค่า</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">c</span>
                                <span>หา <strong class="text-white">"LocalVPN Service"</strong> แล้ว<strong class="text-emerald-400">เปิดสวิตช์</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                <span class="flex-shrink-0 w-5 h-5 bg-emerald-500/30 rounded-full flex items-center justify-center text-xs text-teal-300">d</span>
                                <span>กด <strong class="text-emerald-400">"อนุญาต"</strong> ในหน้าต่างยืนยัน</span>
                            </li>
                        </ol>
                        <div class="bg-amber-500/10 border border-amber-500/30 rounded-xl px-4 py-3 text-amber-200 text-sm flex gap-2">
        ...
        <div class="mb-16" id="step-5">
            <div class="flex flex-col lg:flex-row items-center gap-8">
                <div class="flex-shrink-0">
                    ...
                    @else
                        <div class="phone-frame">
                            <div class="phone-screen bg-gradient-to-b from-emerald-600 to-indigo-700 flex flex-col items-center justify-center p-6 text-center">
                                <div class="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
                                    <span class="text-white text-2xl font-bold">T</span>
                                </div>
                                <p class="text-white text-lg font-bold mb-1">LocalVPN</p>
                                ...
                                <p class="text-emerald-300 text-xs mt-3">มี License แล้ว? <span class="underline">Activate</span></p>
                            </div>
                        </div>
                    @endif
                </div>
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center text-lg font-bold shadow-lg shadow-emerald-500/30">5</span>
        ...
        <div class="mb-16" id="step-6">
            <div class="flex flex-col lg:flex-row-reverse items-center gap-8">
                <div class="flex-shrink-0">
                    ...
                    @else
                        <div class="phone-frame">
                            <div class="phone-screen bg-gradient-to-b from-gray-900 to-gray-900 flex flex-col items-center justify-center p-5 text-center">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h2 class="text-2xl font-bold">Activate License <span class="text-sm font-normal text-teal-300">(เมื่อซื้อแล้ว)</span></h2>
                    </div>
                    <div class="space-y-3 text-teal-200">
                        ...
                        <ol class="space-y-2 text-sm">
                            <li class="flex items-start gap-2">
                                ...
                                <span>ซื้อ License ที่ <a href="{{ route('localvpn.pricing') }}" class="text-emerald-400 hover:text-emerald-300 underline">หน้าราคา</a></span>
                            </li>
                            <li class="flex items-start gap-2">
                            ...
                            <li class="flex items-start gap-2">
                                ...
                                <span>ในแอพ LocalVPN → กด <strong class="text-emerald-400">"Activate License"</strong></span>
                            </li>
                            <li class="flex items-start gap-2">
                                ...
                                <span>กรอก License Key → กด <strong class="text-emerald-400">"Activate"</strong></span>
                            </li>
                        </ol>
                        <div class="bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-4 py-3 text-emerald-200 text-sm flex gap-2">
                            <svg class="w-5 h-5 flex-shrink-0 text-emerald-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            ...
            <div class="space-y-4" x-data="{ open: null }">
                ...
                $faqs = [
                    ...
                    [
                        ...
                        'a' => 'ตรวจสอบว่า Android เวอร์ชัน 8.0 ขึ้นไป, ลองดาวน์โหลดใหม่เผื่อไฟล์เสีย, ถ้ามี LocalVPN เวอร์ชันเก่า ลบออกก่อนแล้วติดตั้งใหม่'
                    ],
                    [
                    ...
                    [
                        ...
                        'a' => 'ตรวจสอบว่าเปิด Accessibility Service แล้ว, ลองปิดแล้วเปิดใหม่, ตรวจสอบว่าแอพไม่ถูก Battery Optimization ปิด — เข้า ตั้งค่า → แบตเตอรี่ → ไม่จำกัด สำหรับ LocalVPN'
                    ],
                    [
                ...
                @foreach($faqs as $i => $faq)
                    <div class="border border-white/10 rounded-xl overflow-hidden">
                        <button @click="open = open === {{ $i }} ? null : {{ $i }}" class="w-full flex items-center justify-between px-5 py-4 text-left hover:bg-white/5 transition-colors">
                            ...
                            <svg class="w-5 h-5 text-teal-400 transform transition-transform" :class="open === {{ $i }} ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                        </button>
                        <div x-show="open === {{ $i }}" x-collapse class="px-5 pb-4 text-teal-200 text-sm">
                            {{ $faq['a'] }}
                        </div>
                    </div>
                @endforeach
        ...
        <div class="text-center space-y-4">
            <a href="{{ route('localvpn.download') }}" class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all hover:-translate-y-0.5 text-lg">
                ...
                ดาวน์โหลด LocalVPN ตอนนี้เลย
            </a>
            <p class="text-teal-400 text-sm">
                ต้องการความช่วยเหลือ?
                <a href="https://line.me/ti/p/@xmanstudio" class="text-emerald-400 hover:text-emerald-300 underline" target="_blank">ติดต่อ LINE @xmanstudio</a>
            </p>
        </div>
