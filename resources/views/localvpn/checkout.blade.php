...
@section('title', 'ชำระเงิน - LocalVPN ' . $planInfo['name'])
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-3">
                                ...
                                <label class="block cursor-pointer" onclick="selectPayment('wallet')">
                                    ...
                                    <div class="relative p-4 border-2 rounded-xl peer-checked:border-purple-500 peer-checked:bg-purple-50 hover:bg-gray-50 bg-gradient-to-r from-purple-50 to-cyan-50">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-cyan-600 flex items-center justify-center mr-4 flex-shrink-0">
                                ...
                                <label class="block cursor-pointer" onclick="selectPayment('promptpay')">
                                    ...
                                    <div class="flex items-center p-4 border-2 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-cyan-50 hover:bg-gray-50">
