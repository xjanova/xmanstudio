        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <label class="relative flex items-start p-4 rounded-xl border border-gray-200 dark:border-gray-600 hover:border-emerald-300 dark:hover:border-emerald-600 cursor-pointer transition-all duration-200 @if(in_array($role->id, old('role_ids', []))) border-emerald-500 bg-emerald-50 dark:bg-emerald-900/20 @endif">
