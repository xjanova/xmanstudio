            ...
            <div class="space-y-4">
                @php
                    $sections = [
                        ...
                        ['key' => 'turnstile_password', 'label' => 'หน้าลืมรหัสผ่าน (Forgot password)', 'desc' => 'แสดง Turnstile ในฟอร์มขอลิงก์ตั้งรหัสผ่านใหม่ — กันบอทยิงรายชื่ออีเมลเพื่อหาว่าบัญชีไหนมีอยู่จริง', 'icon' => 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z'],
                        ...
                        ['key' => 'turnstile_contact', 'label' => 'หน้าติดต่อเรา (Contact)', 'desc' => 'แสดง Turnstile ในฟอร์มติดต่อเรา', 'icon' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
                    ];
                @endphp
