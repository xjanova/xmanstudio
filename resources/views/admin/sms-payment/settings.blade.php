        ...
        <div class="p-6 space-y-4">
            <div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button onclick="copyToClipboard(@js(config('app.url')))" class="px-3 py-3 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 rounded-xl transition-colors" title="คัดลอก">
