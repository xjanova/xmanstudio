...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">เพิ่มบทบาทใหม่</h1>
        </div>
    </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}"
                                    ...
                                    pattern="[a-z_]+" placeholder="เช่น content_manager" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="level" id="level" value="{{ old('level', 10) }}"
                                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.roles.index') }}" class="block w-full px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-lg transition text-center">
                            ยกเลิก
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-6">
                    <h3 class="text-sm font-medium text-blue-900 dark:text-blue-300 mb-2">คำแนะนำ</h3>
                    <ul class="text-sm text-blue-700 dark:text-blue-400 space-y-2">
                        <li>• Level ที่สูงกว่าสามารถจัดการผู้ใช้ที่มี Level ต่ำกว่าได้</li>
                        <li>• Super Admin (Level 100) มีสิทธิ์ทุกอย่างโดยอัตโนมัติ</li>
                        <li>• เลือกสิทธิ์ที่จำเป็นสำหรับบทบาทนี้เท่านั้น</li>
                    </ul>
                </div>
            </div>
        </div>
