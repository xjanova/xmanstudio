    ...
    <div class="relative">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2">แก้ไขสมาชิกทีม Metal-X</h2>
                    <p class="text-orange-100">{{ $metalX->name }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio" rows="3"
                              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:text-white transition-all">{{ old('bio', $metalX->bio) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio_th" rows="3"
                              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:text-white transition-all">{{ old('bio_th', $metalX->bio_th) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    @if($metalX->image)
                        <div class="mb-3">
                            <img src="{{ Storage::url($metalX->image) }}" alt="{{ $metalX->name }}"
                                 class="w-24 h-24 rounded-xl object-cover border border-gray-200 dark:border-gray-600">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">รูปภาพปัจจุบัน</p>
                        </div>
                    @endif
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">รองรับไฟล์รูปภาพ ขนาดไม่เกิน 2MB (เว้นว่างถ้าไม่ต้องการเปลี่ยน)</p>
                    @error('image')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
