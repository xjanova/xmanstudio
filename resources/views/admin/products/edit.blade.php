...
@section('page-title', 'แก้ไขผลิตภัณฑ์')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="features" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">{{ old('features', $product->features) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="image" accept="image/*"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                    <p class="mt-1 text-sm text-gray-500">PNG, JPG, GIF ขนาดไม่เกิน 2MB (อัพโหลดใหม่เพื่อแทนที่รูปเดิม)</p>
                </div>
            </div>
        </div>
