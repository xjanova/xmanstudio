...
@section('page-title', 'เพิ่มหมวดหมู่บริการใหม่')
    ...
    <div class="relative">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2">เพิ่มหมวดหมู่บริการใหม่</h2>
                    <p class="text-pink-100">สร้างหมวดหมู่สำหรับใบเสนอราคา</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.quotations.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
