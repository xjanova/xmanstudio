...
@section('title', 'ซื้อ License - Tping')
    ...
    <section class="relative py-20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center px-4 py-2 bg-violet-500/20 rounded-full text-violet-300 text-sm mb-6 backdrop-blur-sm border border-violet-500/30">
                ...
                Android Accessibility Typing Assistant
            </div>
            ...
            <p class="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                ช่วยพิมพ์ สำหรับผู้ที่ใช้นิ้วไม่สะดวก — ออโต้กรอก บันทึก workflow พิมพ์แทนคุณในทุกแอพ
            </p>

            <div class="flex flex-wrap justify-center gap-4 text-gray-400 text-sm">
                <span class="px-3 py-1 bg-white/5 rounded-full border border-white/10">Auto Fill</span>
                <span class="px-3 py-1 bg-white/5 rounded-full border border-white/10">Workflow Record</span>
                <span class="px-3 py-1 bg-white/5 rounded-full border border-white/10">Cloud Sync</span>
                <span class="px-3 py-1 bg-white/5 rounded-full border border-white/10">Data Profiles</span>
            </div>
        </div>
    </section>
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 hover:border-blue-500 transition-all group">
                    ...
                    <a href="{{ route('tping.checkout', 'monthly') }}{{ $machineId ? '?machine_id=' . $machineId : '' }}"
                ...
                <div class="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border-2 border-violet-500 hover:border-violet-400 transition-all group">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <span class="inline-block mt-2 text-xs font-bold text-green-400 bg-green-400/10 px-3 py-1 rounded-full">ประหยัด {{ \App\Support\LicensePlans::yearlySaving('tping') }}%</span>
                    </div>
                    <ul class="space-y-3 mb-6 text-sm">
                    ...
                    <a href="{{ route('tping.checkout', 'yearly') }}{{ $machineId ? '?machine_id=' . $machineId : '' }}"
                ...
                <div class="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 hover:border-emerald-500 transition-all group">
                    ...
                    <a href="{{ route('tping.checkout', 'lifetime') }}{{ $machineId ? '?machine_id=' . $machineId : '' }}"
        ...
        <div class="relative max-w-3xl mx-auto">
            ...
            <div class="space-y-4">
                <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                    ...
                    <p class="text-gray-400 text-sm">License Key เป็นรหัสสำหรับเปิดใช้งานแอพ Tping หลังจากชำระเงินแล้ว คุณจะได้รับ Key ทางอีเมลเพื่อนำไปกรอกในแอพ</p>
                </div>
                <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
