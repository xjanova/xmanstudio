        ...
        <aside class="w-64 bg-white shadow-lg flex-shrink-0 hidden md:flex md:flex-col h-screen">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('customer.tping.data-profiles.index') }}"
                   class="flex items-center px-4 py-3 rounded-lg transition-all duration-300 group {{ request()->routeIs('customer.tping.data-profiles.*') ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/30' : 'text-gray-600 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-teal-500 hover:text-white hover:shadow-lg hover:shadow-emerald-500/30' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
