            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex">
                    ...
                    <div class="hidden lg:ml-6 lg:flex lg:space-x-0.5 xl:ml-8 xl:space-x-1 lg:items-center">
                        ...
                        <a href="/ai-autotrade" class="group flex items-center xl:gap-1.5 px-2 xl:px-3 py-2 text-sm font-medium transition-all duration-300 rounded-xl {{ request()->is('ai-autotrade*') ? 'bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/30' : 'text-gray-600 dark:text-gray-300 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-teal-500 hover:text-white hover:shadow-lg hover:shadow-emerald-500/30' }}">
