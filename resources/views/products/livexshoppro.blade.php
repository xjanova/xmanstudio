            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="https://github.com/xjanova/Livexshoppro/releases" target="_blank"
                           class="px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white font-bold rounded-xl transition-all transform hover:scale-105 shadow-lg shadow-pink-500/25">
                            ดาวน์โหลด
                        </a>
                        <a href="https://github.com/xjanova/Livexshoppro" target="_blank"
