            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="https://github.com/xjanova/PostXAgent/releases" target="_blank"
                           class="px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-bold rounded-xl transition-all transform hover:scale-105 shadow-lg shadow-orange-500/25">
                            ดาวน์โหลด
                        </a>
                        <a href="https://github.com/xjanova/PostXAgent" target="_blank"
