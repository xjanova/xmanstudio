...
@section('page-title')<x-bi th="แก้ไข Workflow" en="Edit Workflow" />@endsection
...
<div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 max-w-2xl">
    <h2 class="text-xl font-bold text-gray-900 mb-6"><x-bi th="แก้ไข Workflow" en="Edit Workflow" /></h2>
    ...
    <form method="POST" action="{{ route('customer.tping.workflows.update', $workflow) }}" class="space-y-5">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700 mb-1"><x-bi th="ชื่อ Workflow" en="Workflow name" /></label>
        ...
        <div>
            <label for="target_app_name" class="block text-sm font-medium text-gray-700 mb-1"><x-bi th="ชื่อแอพเป้าหมาย" en="Target app name" /></label>
