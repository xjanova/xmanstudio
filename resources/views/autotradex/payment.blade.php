        ...
        <div class="relative overflow-hidden rounded-2xl border border-gray-700 bg-gray-800/40 px-6 py-6 mb-8">
            ...
            <nav class="relative">
                <ol class="flex items-center space-x-2 text-sm text-gray-400">
                    ...
                    <li><span>/</span></li>
                    <li class="text-white font-semibold"><x-bi k="common.payment" /></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-gray-400">
                        <x-bi th="แพ็กเกจ" en="Package" />: <span class="font-semibold text-purple-400">AutoTradeX {{ $planInfo['name'] }}</span>
                    </p>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">
                                    <x-bi th="อัพโหลดสลิปการโอนเงิน" en="Upload payment slip" /> <span class="text-red-400">*</span>
                                </label>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <ul class="mt-1 text-sm text-gray-300 list-disc list-inside space-y-1">
                                ...
                                <li><x-bi th="License Key จะส่งไปยังอีเมล" en="The license key will be sent to your email" />: <span class="text-purple-400">{{ $order->email }}</span></li>
                                ...
                                <li><x-bi th="หากมีข้อสงสัย ติดต่อ Line OA: @xmanstudio" en="For any questions, contact Line OA: @xmanstudio" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
