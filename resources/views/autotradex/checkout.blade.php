...
@section('title', 'ชำระเงิน - AutoTradeX ' . $planInfo['name'])

@section('content')
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Breadcrumb -->
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-900 via-fuchsia-900 to-gray-900 px-6 py-6 mb-8">
            <x-page-art art="card-autotradex" :opacity="15" fade="bottom" :scrim="false" />
            <nav class="relative">
                <ol class="flex items-center space-x-2 text-sm text-gray-300">
                    <li><a href="{{ route('autotradex.pricing') }}" class="hover:text-purple-300">AutoTradeX</a></li>
                    <li><span>/</span></li>
