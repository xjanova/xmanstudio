...
@section('title', 'ชำระเงิน - SmsChecker ' . $planInfo['name'])

@section('content')
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Breadcrumb -->
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-900 via-violet-900 to-gray-900 px-6 py-6 mb-8">
            <x-page-art art="card-smschecker" :opacity="15" fade="bottom" :scrim="false" />
            <nav class="relative">
                <ol class="flex items-center space-x-2 text-sm text-gray-300">
                    <li><a href="{{ route('smschecker.pricing') }}" class="hover:text-violet-300">SmsChecker</a></li>
                    <li><span>/</span></li>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="md:flex">
                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex items-center mb-2">
                                ...
                                <h3 class="font-bold text-xl">SmsChecker</h3>
                            </div>
                            <p class="text-gray-300 text-sm"><x-bi th="ระบบตรวจสอบ SMS อัตโนมัติ" en="Automated SMS Checking System" /></p>
                        </div>
                ...
                <div class="md:w-2/3 p-8">
                    ...
                    <form action="{{ route('smschecker.process', $plan) }}" method="POST" id="checkoutForm">
                        @csrf
                                    ...
                                    <div class="relative p-4 border-2 rounded-xl peer-checked:border-purple-500 peer-checked:bg-purple-50 hover:bg-gray-50 bg-gradient-to-r from-purple-50 to-indigo-50">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-gray-500"><x-bi th="หักจาก Wallet ทันที • ได้ License เลย" en="Deducted from Wallet instantly • Get License immediately" /></p>
                                            </div>
                                        </div>
                                        {{-- Discount badge --}}
                                ...
                                <label class="block cursor-pointer" onclick="selectPayment('bank_transfer')">
                                    ...
                                    <div class="flex items-center p-4 border-2 rounded-xl peer-checked:border-violet-500 peer-checked:bg-violet-50 hover:bg-gray-50">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500"><x-bi th="โอนเงินแล้วแนบสลิป" en="Transfer and attach slip" /></p>
                                        </div>
                                    </div>
                                </label>
                            </div>
                        ...
                        <p class="mt-4 text-sm text-gray-500 text-center">
                            ...
                            <a href="/terms" class="text-violet-600 hover:underline"><x-bi th="ข้อกำหนดการใช้งาน" en="Terms of Service" /></a>
                        </p>
                    </form>
                </div>
            </div>
