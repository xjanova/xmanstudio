...
<head>
    ...
    <title>ดาวน์โหลด SmsChecker - XMAN Studio</title>
...
<body class="min-h-screen bg-gradient-to-b from-gray-900 via-indigo-900 to-gray-900 text-white">
    ...
    <nav class="p-4">
        <div class="max-w-4xl mx-auto flex items-center justify-between">
            ...
            <a href="{{ route('smschecker.pricing') }}" class="text-indigo-300 hover:text-white text-sm transition-colors">ดูราคา</a>
        </div>
    </nav>
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold mb-3">ดาวน์โหลด SmsChecker</h1>
            <p class="text-indigo-300 text-lg">ระบบตรวจจับ SMS ธนาคาร — ตรวจสอบยอดชำระอัตโนมัติ</p>
        </div>
        ...
        <div class="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-8 mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                    <h2 class="text-2xl font-bold mb-2">SmsChecker for Android</h2>
                    @if($version)
                ...
                @if($version)
                    <a href="{{ route('smschecker.download.apk') }}"
        ...
        <div class="bg-white/5 backdrop-blur border border-white/10 rounded-2xl p-8">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('smschecker.download') }}" class="text-sm text-violet-400 hover:text-violet-300 flex items-center gap-1 transition-colors">
                    ดูคู่มือฉบับเต็ม
            ...
            <ol class="space-y-3 text-indigo-200 text-sm">
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>เปิดแอพ SmsChecker แล้วเริ่มทดลองใช้ฟรี 24 ชั่วโมง</span>
                </li>
                <li class="flex items-start gap-3">
                    ...
                    <span>ต้องการใช้งานต่อ? <a href="{{ route('smschecker.pricing') }}" class="text-violet-400 hover:text-violet-300 underline">ซื้อ License</a></span>
                </li>
            </ol>
        </div>
