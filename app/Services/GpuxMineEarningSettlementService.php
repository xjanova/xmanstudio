...
class GpuxMineEarningSettlementService
{
     ...
     *
     * เคยนับจากงานเสร็จอย่างเดียว แต่ aixman เขียนย้อนหลังได้ตลอด GPUXMINE_EARNINGS_SWEEP_DAYS
     * ของฝั่ง aixman (ค่าเริ่มต้น 30 วัน) — catch-up sweep หลัง DB ล่ม, migration ฝั่งนี้ยังไม่ลง,
     * แพ็กเกจเครดิตถูกปิด, ยังไม่รู้เจ้าของ ฯลฯ (งานใดจะหลุดหน้าต่างนั้นในอีก 24 ชม. โดยยังไม่มีแถว
     * aixman จะแจ้งเตือน gpux-earning-expiring) แถวที่เข้ามาช้าจึงพ้นระยะพักตั้งแต่วินาทีที่เกิด
     * และถูกโอนในรอบชั่วโมงถัดไป — ช่วงที่แอดมินจะจับผลงานปลอมได้ทันเหลือศูนย์
     * ระยะพักต้องเริ่มเมื่อเงินปรากฏในระบบให้คนเห็น ไม่ใช่ก่อนนั้น
     *
