...
class AnalyticsController extends Controller
{
    ...
    private function getRevenueChartData(Carbon $startDate): array
    {
        ...
        //
        // completed() rather than status = 'approved': RentalPayment never
        // stores 'approved', so the old filter matched nothing and rental
        // revenue read zero regardless of the date grouping above.
        $rentalRevenue = $this->sumByPeriod(
            RentalPayment::completed()
                ->where('created_at', '>=', $startDate)
