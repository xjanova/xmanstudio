...
const PRODUCTS = [
  ...
  ['WinXTools','Network & System Control','System Utilities',199,0,'ดู bandwidth แยกโปรเซส คุมระดับ kernel ด้วย WFP ถอนโปรแกรมลึกถึง registry มีรุ่นฟรี · Pro ฿199 ต่อปี','Per-process bandwidth, kernel-level WFP control and a deep uninstaller that reaches the registry. Free edition; Pro is ฿199 per year.','#6cf0ff',0],
  ['SMS Payment Checker','WooCommerce Plugin','WordPress Plugins',990,1,'ตรวจเงินเข้าจาก SMS ธนาคาร 15+ แห่ง จับคู่ออเดอร์อัตโนมัติ เข้ารหัส AES-256-GCM','Reads bank SMS from 15+ Thai banks, matches orders automatically, AES-256-GCM encrypted.','#57e08a',0],
  ['SmsChecker','Bank SMS Automation','Mobile Tools',499,1,'ตรวจ SMS ธนาคาร 14+ แห่ง อนุมัติออเดอร์เรียลไทม์ ต่อหลายเซิร์ฟเวอร์พร้อมกัน','Detects bank SMS from 14+ banks, approves orders in real time, multi-server capable.','#e8825a',0],
  ['Tping','Android Auto-Typer','Mobile Tools',399,0,'บันทึกขั้นตอนแล้วเล่นซ้ำได้ถึง 999 รอบ มีโหมดเกมพร้อม crosshair overlay ทดลองฟรี 24 ชม. · ฿399 ต่อเดือน','Record a sequence and replay it up to 999 times, with a game mode and crosshair overlay. Free 24-hour trial; ฿399 per month.','#7dd3fc',0],
  ...
  ['CluadeX','AI Coding Assistant','AI & Automation',199,0,'ผู้ช่วยเขียนโค้ดที่รันบนเครื่องคุณ 5 ผู้ให้บริการ AI, 28 เครื่องมือ, 22+ โมเดลในเครื่อง มีรุ่นฟรี · License ฿199 ต่อปี','A coding assistant that runs on your machine: 5 AI providers, 28 agent tools, 22+ local models. Free edition; a licence is ฿199 per year.','#8b7cf6',0],
  ...
  ['LocalVPN','Virtual LAN over Internet','Network Tools',0,0,'สร้างวง LAN เสมือนข้ามอินเทอร์เน็ต เข้ารหัสด้วย WireGuard ทะลุ NAT ได้ ใช้ฟรีสูงสุด 5 คน · Premium ฿399 ต่อเดือน','A virtual LAN across the internet, WireGuard-encrypted, with NAT traversal. Free for up to 5 members; Premium is ฿399 per month.','#57e08a',0],
